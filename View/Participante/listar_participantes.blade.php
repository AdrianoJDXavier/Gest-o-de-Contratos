                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a class="btn btn-danger" onclick="return confirm('Deseja realmente deletar o cadastro de <?=$participantes->nome?>?')" href="{{route('removeparticipante', $participantes->idParticipante)}}"><i class="icon_trash_alt"></i></a>
                            </div>
                        </td>
                    </tr>
                @endforeach
